      ...
      <div className="math-viz-content">
        <div className="math-viz-input-section">
          <form onSubmit={handleSubmit}>
            ...
            <div className="button-group">
              <button type="submit" className="submit-btn-solve" disabled={loading}>
                Generate Visualization
              </button>
              <button type="button" className="reset-btn-solve" onClick={handleReset} disabled={loading}>
                <FaRedo /> Reset
              </button>
            </div>
          </form>
        ...
        {videoPath && !loading && (
          <div className="video-result">
            ...
            <div className="video-container-solve">
              <video 
                ref={videoRef} 
                controls 
