  ...
  return (
    <div className="app">
      ...
      <div className="content-solve">
        <div className="chat-container-solve">
          <div className="messages-solve">
            {messages.length === 0 && (
            ...
            {messages.map((message, index) => (
              <div
                key={index}
                className={`message-solve ${message.sender === 'user' ? 'user-message-solve' : 'system-message-solve'} ${
          ...
          <form className="input-form-visual" onSubmit={handleSubmit}>
            <input
              type="text"
              value={input}
        ...
        <div className="canvas-container-solve" ref={canvasContainerRef}>
          <div className="canvas-placeholder-solve">
